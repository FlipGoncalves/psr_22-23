...
(cl:defmethod cl:initialize-instance :after ((m <Dog>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Dog)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ex5-msg:<Dog> is deprecated: use ex5-msg:Dog instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Dog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex5-msg:name-val is deprecated.  Use ex5-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Dog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex5-msg:age-val is deprecated.  Use ex5-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <Dog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex5-msg:color-val is deprecated.  Use ex5-msg:color instead.")
  (color m))

(cl:ensure-generic-function 'brothers-val :lambda-list '(m))
(cl:defmethod brothers-val ((m <Dog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ex5-msg:brothers-val is deprecated.  Use ex5-msg:brothers instead.")
  (brothers m))
